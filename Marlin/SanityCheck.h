 ...
 */
  ...
  #if !HAS_RESUME_CONTINUE && DISABLED(FILAMENT_AUTOLOAD)
...
#if ENABLED(DELTA_MOTION_OPTIMIZATION)
  #if DELTA_MOTION_CORNER_FACTOR < 0.0f || DELTA_MOTION_CORNER_FACTOR > 1.0f
    #error "DELTA_MOTION_CORNER_FACTOR must be between 0.0 and 1.0."
  #endif
#endif
