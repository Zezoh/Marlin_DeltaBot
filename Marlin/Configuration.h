...
#define STRING_CONFIG_H_AUTHOR "(Abdulaziz Halawani, DeltaBot)" // Who made the changes.
...
#ifndef MOTHERBOARD
    #define MOTHERBOARD BOARD_MKS_MINI_20
#endif
...
#define DEFAULT_AXIS_STEPS_PER_UNIT   { DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, DEFAULT_XYZ_STEPS_PER_UNIT, 95.25 }  // 405 default steps per unit for Kossel (GT2, 20 tooth)
 ...
 *
 */
//#define Z_MIN_PROBE_ENDSTOP 68 // A3K leave disabled!
...
#define FILAMENT_RUNOUT_SENSOR
  ...
  // Trigger a loading sequence for extruder-mounted runout sensors (e.g. Prusa).
...
#define NOZZLE_PARK_FEATURE
  ...
  #define NOZZLE_PARK_POINT { 0, -70, 20 }
  #define NOZZLE_PARK_XY_FEEDRATE 50   // X and Y axes feedrate in mm/s (also used for delta printers Z axis)
  //#define NOZZLE_PARK_Z_FEEDRATE      // Z axis feedrate in mm/s (not used for delta printers)
#endif
