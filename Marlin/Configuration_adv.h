...
#define JUNCTION_DEVIATION_MM 0.015 // (mm) Distance from real junction edge; lower for quieter, smoother turns
#endif
...
//#define LED_CONTROL_MENU
  ...
  #define SD_FINISHED_RELEASECOMMAND "G28" // You might want to keep the z enabled so your bed stays in place.
...
#define ADVANCED_PAUSE_FEATURE
  ...
  #define PAUSE_PARK_NOZZLE_TIMEOUT           50  // (seconds) Time limit before the nozzle is turned off for safety.
