  ...
  void lcd_cooldown() {
    ...
    void lcd_bed_leveling() {
      ...
      //
        ...
        MENU_ITEM(submenu, MSG_ZPROBE_ZOFFSET, lcd_babystep_zoffset);
      #elif HAS_BED_PROBE
        MENU_ITEM_EDIT(float43, MSG_ZPROBE_ZOFFSET, &zprobe_zoffset, Z_PROBE_OFFSET_RANGE_MIN, Z_PROBE_OFFSET_RANGE_MAX);
      #endif
  ...
  float move_menu_scale;
    ...
    void lcd_delta_calibrate_menu() {
      ...
      MENU_BACK(MSG_MAIN);
		...
		MENU_ITEM(gcode, MSG_DELTA_LONG_CALIBRATE, PSTR("G33 P3\nM500"));
