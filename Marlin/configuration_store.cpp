...
typedef struct SettingsDataStruct {
  ...
  //
    ...
    float delta_height,                                 // M666 H
          ...
          delta_diagonal_rod_trim[ABC];                 // M665 ABC
...
void MarlinSettings::reset() {
  ...
  //
    ...
    const float adj[ABC] = DELTA_ENDSTOP_ADJ,
                ...
                ddr[ABC] = DELTA_DIAGONAL_ROD_TRIM_TOWER;
    ...
    COPY(delta_diagonal_rod_trim, ddr);
  ...
  void MarlinSettings::report(const bool forReplay) {
     ...
     */
      ...
      if (!forReplay) {
        CONFIG_ECHO_START;
        SERIAL_ECHOLNPGM("Delta settings: L<diagonal rod> R<radius> H<height> S<segments per sec> K<calibration radius> XYZ<tower angle corrections> ABC<rod trim>");
      }
      CONFIG_ECHO_START;
      ...
      SERIAL_ECHOPAIR(" K", LINEAR_UNIT(delta_calibration_radius));
